...
namespace Raman
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      // miTools
      // 
      this.miTools.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {this.miBaselineCorrection});
      ...
      // toolStrip
      // 
      this.toolStrip.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {this.tsbRefresh, this.tsbOpenFiles, this.tsbZoomToWindow, this.tsbZoomToOriginalSize, this.tsbBaselineCorrection});
